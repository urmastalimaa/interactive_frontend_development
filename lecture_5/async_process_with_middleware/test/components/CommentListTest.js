...
describe('CommentList', () => {
  ...
  it('renders Comment component for each comment', () => {
    ...
    expect(commentList).to.contain(<Comment author="a" children="a-text" inFlight={true} />);
    expect(commentList).to.contain(<Comment author="b" children="b-text" inFlight={false} />);
  });
